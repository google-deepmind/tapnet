...
from tapnet import tapir_model  # pylint:disable=g-importing-member
from tapnet import tapnet_model  # pylint:disable=g-importing-member
from tapnet import task  # pylint:disable=g-importing-member
