...
def preprocess_frame(
    ...
    t = torch.from_numpy(frame_rgb).to(device, non_blocking=True)  # [H, W, 3] uint8
...
def make_query_tensor(
    ...
    Args:
        ...
        device: Target device.
        query_timestep: Frame index at which the query points are defined
            (0 = current / first frame).
